...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const advertismets = document.querySelectorAll('.promo__adv img'),
        promoPoster = document.querySelector(".promo__bg"),
        promoGenre = document.querySelector(".promo__genre"),
        movieList = document.querySelector(".promo__interactive-list"),
        filmInput = document.querySelector("input.adding__input"),
        filmForm = document.querySelector('form.add'),
        isFavorite = document.querySelector('form.add input[type="checkbox"]');
    ...
    filmForm.addEventListener('submit', event => {
        ...
        let favorite = isFavorite.checked;
    ...
    function createMovieList(films, parent) {
        ...
        movieList.querySelectorAll('li div.delete').forEach((element, i) => {
